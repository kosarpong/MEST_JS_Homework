 ...
 *  Answer: This outputs the windows object on the console because the 'this' method points to the parent object which is the window object.
 * 
 * 
 *  var obj = {
 ...
 *  Answer:  This will output the obj object because 'this' in the function 'func' now points to the obj object not the main windows object.

 * 
 * 
 *  obj.func.bind(window)(); // what is the output? why?
 *  Answer: This will display the windows object because the function 'func' is now bound to the windows object and not 'obj' object.
 *
 *  obj.func.bind(this)();  // what is the output? why?
 *  Answer: This will output the windows object because 'this' binds the 'func' to the windows object.
 * 
 *  var people = {
 *      name: 'ashwin',
 *      age: 40
 ...
 */
   // Answer: This will output out the 'people' object because 'func' is now bound to 'people' object.
 ...
 */
  ...
  reGex.test('kwamesarpong@gmail.com');
/*
...
/*  Response
  ...
  For sessionStorage, changes are only available per each browsing session in the window (or tabs in browsers like Chrome and Firefox). 
